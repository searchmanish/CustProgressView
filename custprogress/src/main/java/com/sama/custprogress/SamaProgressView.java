...
public class SamaProgressView extends View {
    ...
    public SamaProgressView(Context context) {
        super(context);
        init(null, 0);
    }

    public SamaProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public SamaProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void init(AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.SamaProgressView, defStyle, 0);
        mThickness = a.getDimensionPixelSize(R.styleable.SamaProgressView_dpv_thickness,
                resources.getDimensionPixelSize(R.dimen.default_thickness));
        mInnerPadding = a.getDimensionPixelSize(R.styleable.SamaProgressView_dpv_inner_padding,
                resources.getDimensionPixelSize(R.dimen.default_inner_padding));

        mOuterCircleColor = a.getColor(R.styleable.SamaProgressView_dpv_inner_color,
                ContextCompat.getColor(getContext(), R.color.progress_outer_color));
        mInnerCircleColor = a.getColor(R.styleable.SamaProgressView_dpv_outer_color,
                ContextCompat.getColor(getContext(), R.color.progress_inner_color));
        mAnimDuration = a.getInteger(R.styleable.SamaProgressView_dpv_anim_duration,
